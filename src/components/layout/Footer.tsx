...
//
// Intégration visuelle : le footer n'a AUCUN fond ni motif à lui — il est
// totalement transparent. La seule surface visible derrière lui est le fond
// GLOBAL du site (couche fixe #111111 + motif « $ ? » dans layout.tsx), qui
// transparaît à travers. D'où une surface continue, sans duplication ni jointure.
// Seule subsiste une fine ligne de séparation discrète en haut.
...
export default function Footer() {
  ...
  return (
    // Transparent : laisse voir le fond global du site (layout.tsx). z-10 → au-dessus
    // de la couche de fond (-z-10), liens parfaitement lisibles.
