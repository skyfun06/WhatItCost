export const fr = {
  ...
  settings: {
    ...
    theme: 'Thématique',
    themeNone: 'Aucun thème',
    themeBudgetOnly: 'Catalogue limité : ce thème se joue uniquement en Budget Guess.',
    themes: {
      'annees-80': 'Années 80',
      'annees-90': 'Années 90',
      ...
      marvel: 'Marvel',
      'animation-studios': 'Studios d’animation',
      pixar: 'Pixar',
      zombies: 'Zombies',
      braquages: 'Braquages',
  ...
  // Vraie page Paramètres (onglet du dock mobile) — préférences de l'app, à ne
  // pas confondre avec `settings` ci-dessus qui configure une partie (/configure).
  prefs: {
    eyebrow: 'Paramètres',
    title: 'Tes paramètres',
    subtitle: 'Profil, préférences et données — le tout sur cet appareil.',
    profileLabel: 'Profil',
    nickname: 'Pseudo',
    nicknameHint: 'Utilisé pour le classement et le multijoueur.',
    ...
    hapticsHint: 'Vibrations légères au toucher des boutons (mobile).',
    on: 'Activé',
    off: 'Désactivé',
    accountLabel: 'Compte',
    ...
    synced: 'Synchronisé ✓',
    holBestLabel: 'Meilleure chaîne (Higher or Lower)',
    loadingAccount: 'Chargement du compte…',
    authError: 'La connexion a échoué. Réessaie.',
    dataLabel: 'Données',
    dataDesc: 'Tes scores, records et préférences sont stockés uniquement sur cet appareil, jamais sur un serveur.',
    clearData: 'Effacer mes données locales',
    clearConfirm: 'Confirmer l\'effacement',
    cancel: 'Annuler',
