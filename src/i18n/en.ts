export const en = {
  ...
  // Real Settings page (mobile dock tab) — app preferences, not to be confused
  // with `settings` above which configures a game (/configure).
  prefs: {
    eyebrow: 'Settings',
    title: 'Your settings',
    subtitle: 'Profile, preferences and data — all on this device.',
    profileLabel: 'Profile',
    nickname: 'Nickname',
    nicknameHint: 'Used for the leaderboard and multiplayer.',
    nicknamePlaceholder: 'Your nickname',
    save: 'Save',
    saved: 'Saved ✓',
    invalidName: 'Invalid nickname (2–20 characters).',
    prefsLabel: 'Preferences',
    language: 'Language',
    haptics: 'Haptic feedback',
    hapticsHint: 'Light vibrations when tapping buttons (mobile).',
    on: 'On',
    off: 'Off',
    ...
    syncing: 'Syncing…',
    synced: 'Synced ✓',
    holBestLabel: 'Best chain (Higher or Lower)',
    loadingAccount: 'Loading account…',
    authError: 'Sign-in failed. Please try again.',
    dataLabel: 'Data',
    dataDesc: 'Your scores, records and preferences are stored only on this device, never on a server.',
